...
public class EventAttendanceControllers : Controller
{
    ...
    public async Task<IActionResult> CreateAttendance([FromBody] JsonElement obj)
    {
        ...
        {
            EventAttendance attendance = JsonSerializer.Deserialize<EventAttendance>(obj.ToString())!;
            ...
            if (!EAS.TestDate(evt)) return BadRequest("Because of the date of this event, you can no longer attend these.");
    ...
    [HttpGet("get-event-attendances-on-event")]
    [LoggedInFilter]
